...
<body>
    <div class="d-flex" id="content-wrapper">
		...
		<br>
        <div class="container">
		<h1 class="page-header text-center">Gestionar Colegios</h1>
				<div class="row">
				<div class="col-sm-12 col-sm-offset-2">
				<a href="/php/NuevoColegio.php" class="btn btn-primary" data-toggle="modal"><span class="glyphicon glyphicon-plus"></span> Nuevo Colegio</a>
				...
				<table class="table table-bordered table-striped" style="margin-top:20px;">
					...
					<tbody>
						...
						$db = $database->open();
						try {
							$sql = 'SELECT id, UPPER(nombre) as nombre, UPPER(sector) as sector , UPPER(ciudad) as ciudad from colegios';
