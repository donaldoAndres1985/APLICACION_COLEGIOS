            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 col-sm-offset-2">
                        <form id="formContrato" method="post" action="/php/AgregarCargaAcademica.php">
                            <h1 class="page-header text-center">Nueva Carga Cademica</h1>
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <div class="col-md-8">
                                        ...
                                        <select class="custom-select custom-select-sm form-control item" name="asignatura">
                                            ...
                                            try {
                                                ...
                                                $sql = 'SELECT id,upper(asignatura) as asignatura FROM asignatura';

                                                foreach ($db->query($sql) as $row) {

                                                    echo '<option value="' . $row["id"] . '">' . $row["asignatura"] . '</option>';
                                                }
                                            } catch (PDOException $e) {
                                                echo "Hubo un problema en la conexión: " . $e->getMessage();
                                            }
                                ...
                                <div class="form-group">
                                    <div class="col-md-8">
                                        ...
                                        <select class="custom-select custom-select-sm form-control item" name="dia">
                                            <option selected>Seleccione Dia</option>

                                            <option value="Publico">LUNES</option>
                                            <option value="Privado">MARTES</option>
                                            <option value="Privado">MIERCOLES</option>
                                            <option value="Privado">JUEVES</option>
                                            <option value="Privado">VIERNEZ</option>
