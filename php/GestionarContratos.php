...
<body>
    <div class="d-flex" id="content-wrapper">
		...
		<h1 class="page-header text-center">Contratos</h1>
				<div class="row">
				<div class="col-sm-12 col-sm-offset-2">
				<a href="/php/NuevoContrato.php" class="btn btn-primary" data-toggle="modal"><span class="glyphicon glyphicon-plus"></span> Nuevo Contrato</a>
					...
					<tbody>
						...
						try {
							...
							$sql = 'SELECT contratos.id as id,
                                    ...
                                    contratos.fechaEntrada as fechaEntrada,
                                    contratos.fechaSalida as fechaSalida,
			                        upper(contratos.estado) as estado 
                                    FROM contratos,colegios,docentes
                                    WHERE contratos.idColegio = colegios.id AND
                                     contratos.idDocente =  docentes.id';
