		...
		<br>
            ...
            <div class="row">
				<div class="col-sm-12 col-sm-offset-2">
                 <form  id="formDocente" method="post" action="/php/AgregarDocentes.php">
                         <h1 class="page-header text-center">Nuevo Docente</h1>
							<fieldset>
                                <div class="form-group">
                                    <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span>
                                    <div class="col-md-8">
                                        <input id="cCiudadania" name="cedula" type="text" placeholder="Cedula Ciudadania" class="form-control item" maxlength="15" minlength="4" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span>
                                    <div class="col-md-8">
                                        <input id="nDocente" name="nombres" type="text" placeholder="Nombres del Docente" class="form-control item" maxlength="100" minlength="4" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input id="nEmail" name="apellidos" type="text" placeholder="Apellidos del Docente" class="form-control item" maxlength="100" minlength="4" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input id="ntelefono" name="telefono" type="text" placeholder="Telefono del Docente" class="form-control item" maxlength="15" minlength="4" required> 
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-phone-square bigicon"></i></span>
                                    <div class="col-md-8">
                                        <input id="Ndireccion" name="direccion" type="text" placeholder="Direccion del Docente" class="form-control item" maxlength="100" minlength="4" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 text-center">
                                        ...
                                        <a href="/index.php" class="btn btn-primary btn-lg" ><span class="glyphicon glyphicon-plus"></span> Regresar</a>
                                    </div>
